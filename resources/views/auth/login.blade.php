<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" oninvalid="setCustomValidity('Please enter your password.')" oninput="setCustomValidity('')" required
