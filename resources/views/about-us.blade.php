...
<div class="wrapper-about">
        ...
        <section class="about-container m-0 p-0 box-border line-height: 1.5; height: 43.75rem;">
          <div class="about-us">
            <h1 class="text-center text-[2em] mt-[2vh]">About Us</h1>
            <div class="container flex justify-center items-center flex-col px-[5vw] py-[0] mx-[auto] my-[5vh]">
              <div class="content w-[70%] text-left px-[2vw] py-[0]">
                <h3 class="text-[black] tracking-[1px] w-full mt-[2vh]">Welcome to Flippinpages</h3>
              ...
              <div class="image-section w-full h-auto px-[2vw] py-[0]">
                <img class= "w-full px-[2vw] py-[0] flex justify-center items-center" src="/images/about-us1.jpg" alt="">
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="about-container m-0 p-0 box-border line-height: 1.5; height: 43.75rem;">
          <div class="about-us">
            <div class="container flex justify-center items-center flex-col px-[5vw] py-[0] mx-[auto] my-[5vh]">
            <div class="image-section w-full h-auto px-[2vw] py-[0]">
                <img calss="w-full px-[2vw] py-[0] flex justify-center items-center" src="/images/about-us2.jpg" alt="">
              </div>
              <div class="content w-[70%] text-left px-[2vw] py-[0]">
              <h3 class="text-[black] tracking-[1px] w-full mt-[2vh]">Our Vision</h3>
        ...
        <section class="about-container m-0 p-0 box-border line-height: 1.5; height: 43.75rem;">
          <div class="about-us w-full">
            <div class="container flex justify-center items-center flex-col px-[5vw] py-[0] mx-[auto] my-[5vh]">
              <div class="content w-[70%] text-left px-[2vw] py-[0]">
              <h3 class="text-[black] tracking-[1px] w-full mt-[2vh]">The Founders</h3>
              ...
              <div class="image-section w-full h-auto px-[2vw] py-[0]">
                <img class="w-full px-[2vw] py-[0] flex justify-center items-center" src="/images/about-us3.jpg" alt="">
              </div>
            </div>
          </div>
        </section>
        <section class="about-container">
          <div class="about-us w-full">
            <div class="container flex justify-center items-center flex-col px-[5vw] py-[0] mx-[auto] my-[5vh]">
              <div class="content w-[70%] text-left px-[2vw] py-[0]">
              <h3 class="text-[black] tracking-[1px] w-full mt-[2vh]">Find Us</h3>
                <p>Address:</p> <br>
                <br>
                WHSmith<br>
