...
<body>
    ...
    <div class="contact-form">
        ...
        <form action="mailto:21mafiozi21@gmail.com" method="POST" enctype="text/plain" class="shadow-md rounded">
            <h2>Get in Touch</h2>
            {{-- @guest --}}
            <div class="names">
            ...
            <button type="submit" class="text-white py-2 px-4 rounded">Send</button>
        </form>
    </div>
