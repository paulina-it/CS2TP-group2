    ...
    <div class="contact-form">
        ...
        <form action="{{ route('contact.store') }}" method="POST" class="rounded">
            ...
            <div class="names">
                ...
                <label for="last-name" id="ln-label">Last Name</label>
                {{-- fix after register --}}
                <input type="text" name="first-name" id="fn-input" value="{{Auth::user()->firstName}}" required>
                <input type="text" name="last-name" id="ln-input" value="{{Auth::user()->lastName}}" required>
            </div>
            <label for="email">Email</label>
            ...
            <textarea id="message" rows="4" name="message" placeholder="Write your thoughts here..." required></textarea>
