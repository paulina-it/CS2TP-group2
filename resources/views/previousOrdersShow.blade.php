...
@section('main')
    <div class="prev-orders-show">
        ...
        <div class="prev-orders-single-list">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="eventPreventDefault()" type="button"
                                    class="review-btn py-2 px-4 rounded btn" data-modal-toggle="modal{{ $items[$i]['id'] }}"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form action="{{ route('product-rating.create', $items[$i]['id']) }}"
                                                    ...
                                                    <button data-modal-hide="modal{{ $items[$i]['id'] }}" type="button"
            ...
            <div class="prev-order-summary flex w-full justify-around">
                <?php
                ...
                <label>Status: {{ $order[0]['status'] }}</label>
